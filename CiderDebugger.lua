...
local CiderRunMode = {};CiderRunMode.runmode = 'DEBUG';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/tonygod/Library/Application Support/luaglider2/dev";local SOCKET_PORT=52659;local GLIDER_MAIN_FOLDER= "/Users/tonygod/Documents/source/LD35_Shapeshifter";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
